                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body w-100 px-2                                                                                                                                                                                                              ">
                                    <table id="example2" class=" table-hover table-responsive table table-striped table-bordered text-center">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th>Categoria</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group mt-3">
                                                            <a href="accionesProducto/actualizarProducto.php?id=<?= $mostrar['id_producto'] ?>" class="btn btn-outline-primary"><i class="fas fa-edit"></i></a>
                                                            <a class="btn btn-outline-danger" href="accionesProducto/eliminarProducto.php?id=<?= $mostrar['id_producto'] ?>"><i class="fas fa-trash-alt"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php } ?>
