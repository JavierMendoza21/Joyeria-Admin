                            ...
                            <div class="card card-primary card-default ">
                                ...
                                <div class="card-body">
                                    <div class="mb-3 text-center">
                                        <img src="../<?= $mostrarCambio['imgUsuario'] ?>" class="img-circle elevation-2" width="115" alt="<?= $mostrarCambio['imgUsuario'] ?>">
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><span class="badge mt-4 <?= ($mostrar['stock'] < 10) ? "badge-danger" : (($mostrar['stock'] < 20) ? "badge-warning" : "badge-success") ?> d-block"><?php echo $mostrar['stock'] ?></span></td>
                                                            <form action="removerProductoUsuario.php?id=<?= $_GET['id'] ?>&idProducto=<?= $mostrar['id_producto'] ?>" autocomplete="off" method="POST">
                                                                <td>
                                                                    <div class="form-group mt-3">
                                                                        <input id="" name="valor" max="<?= $mostrar['stock'] ?>" min='0' value="0" class="form-control" type="number" name="">
                                                                    </div>
                                                                </td>
                                                                <td>
                        ...
                        <div class="col-12">
                            <div class="card card-primary card-default ">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-5 justify-content-center">
                                        <div class="col-12">
                                            <table id="example1" class="table-sm table-hover table-responsive table table-striped table-bordered text-center">
                                                <thead>
                                                    <tr>
                                                        <th></th>
                                                        <th>Categoria</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <form action="asignarProductoUsuario.php?id=<?= $_GET['id'] ?>&idProducto=<?= $mostrar['id_producto'] ?>" autocomplete="off" method="POST">
                                                                <td>
                                                                    <div class="form-group mt-3">
                                                                        <input id="" name="valor" max="<?= $mostrar['stock'] ?>" min='0' value="0" class="form-control" type="number" name="">
                                                                    </div>
