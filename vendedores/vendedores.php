                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="vendedores.php" class="nav-link active">
                                    ...
                                    <table id="example2" class="w-100 text-center table-hover table-sm table table-bordered table-striped table-responsive">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                $imagenUser = "SELECT * FROM usuarios";



                                                while ($mostrar = mysqli_fetch_array($result)) {

                                                    if (($mostrar['imgUsuario'] == 'user-default.jpg') || ($mostrar['imgUsuario'] == '')) {
                                                        $imagenUser = '../uploads/user-default.jpg';
                                                    } else {
                                                        $imagenUser = $mostrar['imgUsuario'];
                                                        //echo 'Buscar : ' . '../' . $imagenUser . '<br>';
