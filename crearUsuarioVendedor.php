        ...
        <div class="row justify-content-center">
            <div class="col-sm-12 col-lg-7 col-md-8 mt-0">
                <div class="card card-primary">
                    ...
                    <!-- form start -->
                    <form role="form" class="" action="" onsubmit="return comprobar()" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="dividir">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="pass" id="pass" class="form-control" id="exampleInputPassword1" placeholder="Contraseña" require>
